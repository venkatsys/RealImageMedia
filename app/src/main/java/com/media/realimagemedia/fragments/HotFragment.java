...
public class HotFragment extends BaseFragment {
    ...
    private void init(View view) {
        ...
        SectionData sectionData = new SectionData() {
            ...
            public void DisplaySections(StackoverflowData sectionDatas) {
                Constants.EmptyTable(AppConstants.DONE_QUESTION_SECTION_HOT);
                localUpdateff.TogetStackoverflowResults(sectionDatas,AppConstants.DONE_QUESTION_SECTION_HOT);
                localUpdateff.run();
            }
        ...
        toAddClass(AppConstants.HOT,FeaturedFragment.class);
    }
    /**
    ...
    private void ToCheckRecords() {
        this.todoUri = null;
        this.todoUri = Uri.parse("content://com.realmedia/hot/question/get");
