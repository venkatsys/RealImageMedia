...
public class MonthFragment extends BaseFragment {
    ...
    private void init(View view) {
        ...
        SectionData sectionData = new SectionData() {
            ...
            public void DisplaySections(StackoverflowData sectionDatas) {
                Constants.EmptyTable(AppConstants.DONE_QUESTION_SECTION_MONTH);
                localUpdateff.TogetStackoverflowResults(sectionDatas,AppConstants.DONE_QUESTION_SECTION_MONTH);
                localUpdateff.run();
            }
    ...
    private void ToCheckRecords() {
        this.todoUri = null;
        this.todoUri = Uri.parse("content://com.realmedia/month/question/get");
