...
public class FeaturedFragment extends BaseFragment{
    ...
    private void init(View view) {
        ...
        SectionData sectionData = new SectionData() {
            ...
            public void DisplaySections(StackoverflowData sectionDatas) {
                Constants.EmptyTable(AppConstants.DONE_QUESTION_SECTION_FEATURED);
                localUpdateff.TogetStackoverflowResults(sectionDatas,AppConstants.DONE_QUESTION_SECTION_FEATURED);
                localUpdateff.run();
            }
    ...
    private void ToCheckRecords() {
        this.todoUri = null;
        this.todoUri = Uri.parse("content://com.realmedia/featured/question/get");
